...
import com.telnet.enjeux_strategique.dto.UserDto;
...
public interface TokenClient {
    ...
    ResponseEntity<Object> getTokenByValue(@PathVariable("token") String token);

    @PutMapping("/tokens/update")
    ResponseEntity<Object> updateTokenStatus(@RequestBody Object token);
    ...
    UserDto loadUserByUsername(@PathVariable("email") String email);

    @GetMapping("/tokens/userDetails")
    ResponseEntity<UserDto> getUserDetailsFromToken(@RequestParam("token") String token);
