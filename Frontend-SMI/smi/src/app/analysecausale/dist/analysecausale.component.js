...
exports.AnalysecausaleComponent = void 0;
...
var AnalysecausaleComponent = /** @class */ (function () {
    function AnalysecausaleComponent(formBuilder, analyseService, route, projectService, dialog) {
        ...
        this.showTable1 = true; // Afficher le tableau 1 par défaut
        this.showTable2 = false; // Ne pas afficher le tableau 2 par défaut
        this.refreshModal = new core_1.EventEmitter();
    }
    AnalysecausaleComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.getAnalysesForProject(_this.projectId);
            _this.getCausesForAnalyse(_this.analyseId);
        });
    };
    AnalysecausaleComponent.prototype.getCausesForAnalyse = function (analyseId) {
        var _this = this;
    ...
    AnalysecausaleComponent.prototype.hideNomCauseAndPourcentage = function () {
        var causes = this.causesFormArray;
        while (causes.length !== 0) {
            causes.removeAt(0);
        }
    };
    AnalysecausaleComponent.prototype.initCauseFormGroup = function () {
        return this.formBuilder.group({
            nomCause: ['', forms_1.Validators.required],
            pourcentage: ['', forms_1.Validators.required]
        });
    };
    AnalysecausaleComponent.prototype.onModification = function () {
        this.refreshModal.emit();
        this.getAnalysesForProject(this.projectId);
    };
    AnalysecausaleComponent.prototype.addCause = function () {
        var causes = this.causesFormArray;
    ...
    AnalysecausaleComponent.prototype.resetForm = function () {
    ...
    AnalysecausaleComponent.prototype.showAlert = function (message, type) {
    ...
    AnalysecausaleComponent.prototype.openModal = function (analyseId) {
        var dialogRef = this.dialog.open(modalcauses_component_1.ModalcausesComponent, {
            // width: '600px',
            data: { analyseId: analyseId }
        });
    };
    AnalysecausaleComponent.prototype.refreshModalContent = function (analyseId) {
        this.getCausesForAnalyse(analyseId);
    };
    AnalysecausaleComponent.prototype.addDynamicFields = function () {
        var causes = this.causesFormArray;
        if (this.analyseForm.valid) {
    ...
    AnalysecausaleComponent.prototype.removeCause = function (index) {
        var causes = this.causesFormArray;
        causes.removeAt(index);
    };
    Object.defineProperty(AnalysecausaleComponent.prototype, "causesFormArray", {
        get: function () {
    ...
    AnalysecausaleComponent.prototype.arePreviousFieldsFilled = function (index) {
        if (index === 0) {
            return true;
        }
    ...
    AnalysecausaleComponent.prototype.openModifierAnalyseModal = function (analyseId) {
        var _this = this;
    ...
    AnalysecausaleComponent.prototype.onDeleteAnalyseCausale = function (analyseId) {
        var _this = this;
        sweetalert2_1["default"].fire({
            title: 'Êtes-vous sûr?',
    ...
    AnalysecausaleComponent.prototype.getProjectDetails = function () {
        var _this = this;
        this.projectService.getProjectDetails(this.projectId).subscribe(function (project) {
            _this.projectDetails = project;
            _this.projectName = project.name;
            _this.activity = project.activity;
            _this.client = project.client;
        }, function (error) {
            console.error('Erreur lors de la récupération des détails du projet :', error);
        });
    };
    AnalysecausaleComponent.prototype.nextStep = function () {
        this.step++;
    };
    AnalysecausaleComponent.prototype.prevStep = function () {
        this.step--;
    };
    AnalysecausaleComponent.prototype.calculateProgress = function () {
        return '33%';
    };
    AnalysecausaleComponent.prototype.onInputChange = function (event, prochainPourquoi) {
    };
    AnalysecausaleComponent.prototype.onSubmit = function () {
        var _this = this;
        if (this.analyseForm.valid) {
            var analyse = {
            ...
            this.analyseService.ajouterAnalyseCausale(this.projectId, analyse).subscribe(function (response) {
    ...
    AnalysecausaleComponent.prototype.isValidForm = function () {
    ...
    AnalysecausaleComponent.prototype.getAnalysesForProject = function (projectId) {
        var _this = this;
        this.analyseService.getAnalysesForProject(projectId)
            .subscribe(function (analyses) {
            _this.analyses = analyses;
            console.log('Analyses for project:', analyses);
            var _loop_1 = function (analyse) {
                _this.analyseService.getCausesForAnalyse(analyse.id).subscribe(function (causes) {
    ...
    __decorate([
        core_1.Output()
    ], AnalysecausaleComponent.prototype, "refreshModal");
    AnalysecausaleComponent = __decorate([
        core_1.Component({
    ...
    return AnalysecausaleComponent;
}());
exports.AnalysecausaleComponent = AnalysecausaleComponent;
